...
public class DashboardReadPlatformServiceImpl implements DashboardReadPlatformService {
    ...
    /*
     * private static final String PENDING_APPROVAL_LOANS = "select count(l.id) as count \n" + "from   m_client c \n" +
    ...
    @Autowired
    public DashboardReadPlatformServiceImpl(final RoutingDataSource dataSource, final PlatformSecurityContext context,
    ...
    @Override
    public JSONObject generalManagerLandingRetrieveDashboardTemplate(String chartType, DateParam from, DateParam to, Long productId,
            Long officeId) {
        ...
        if (chartType.equalsIgnoreCase("activeCustomer")) {
            DataList = retrieveActiveCustomersForLanding(from, to).stream().collect(Collectors.toList());
            String[] categories = new String[DataList.size()];
            BigDecimal[] series = new BigDecimal[DataList.size()];
            /*
             * JSONObject chart = new JSONObject(); chart.put("width", "100%"); chart.put("type", "pie");
             */
        ...
        if (chartType.equalsIgnoreCase("PARPerBranch")) {
            DataList = retrievePARPerBranchForLanding(from, to).stream().collect(Collectors.toList());
            String[] categories = new String[DataList.size()];
            BigDecimal[] series = new BigDecimal[DataList.size()];
            /*
             * JSONObject chart = new JSONObject(); chart.put("width", "100%"); chart.put("type", "pie");
        ...
        if (chartType.equalsIgnoreCase("LoanInBadStanding")) {
            DurationDataList = retrieveLoanInBadStandingForLanding(from, to).stream().collect(Collectors.toList());
            String[] categories = { "current", "1-30 days", "30-60 days", "60-90 days", "90+" };
            BigDecimal[] series = { DurationDataList.get(0).getCurrent(), DurationDataList.get(0).getPAR1(),
                    DurationDataList.get(0).getPAR31(), DurationDataList.get(0).getPAR61(), DurationDataList.get(0).getPAR91() };
        ...
        if (chartType.equalsIgnoreCase("SavingsBalancePerBranch")) {
            DurationDataList = retrieveSavingsBalancePerBranchForLanding(from, to, productId).stream().collect(Collectors.toList());
            if (productId == null) {
            ...
            if (DurationDataList.size() > 0) {
                BigDecimal[] series1 = { DurationDataList.get(0).getCurrent(), DurationDataList.get(0).getPAR1(),
                        DurationDataList.get(0).getPAR31(), DurationDataList.get(0).getPAR61(), DurationDataList.get(0).getPAR91() };
                series = series1;
            }
        ...
        if (chartType.equalsIgnoreCase("CustomerNumbersBranch")) {
            StackedDataList = retrieveCustomersNumberBranchForLanding(from, to, officeId).stream().collect(Collectors.toList());
            if (officeId == null) {
                officeId = 1L;
            }
            String[] categories = { "ActiveCustomers", "NonActiveCustomer", "Prospects" };
            BigDecimal[] series = { StackedDataList.get(0).getActiveCustomers(), StackedDataList.get(0).getNonActiveCustomer(),
                    StackedDataList.get(0).getNonFundedCustomer() };
        ...
        if (chartType.equalsIgnoreCase("LoansToBePaidInCurrentWeek")) {
            WeeklyDataList = retrieveLoansToBePaidInCurrentWeekForLanding(from, to).stream().collect(Collectors.toList());
            ...
            BigDecimal[] series = { WeeklyDataList.get(0).getDay1(), WeeklyDataList.get(0).getDay2(), WeeklyDataList.get(0).getDay3(),
                    WeeklyDataList.get(0).getDay4(), WeeklyDataList.get(0).getDay5(), WeeklyDataList.get(0).getDay6(),
                    WeeklyDataList.get(0).getDay7() };
        ...
        if (chartType.equalsIgnoreCase("todolist")) {
            ...
            noOfCenters = retrieveNoOfCentersForLanding().stream().collect(Collectors.toList());

            List<ToDoListData> noOfGroups = new ArrayList<ToDoListData>();
            noOfGroups = retrieveNoOfGroupsForLanding().stream().collect(Collectors.toList());

            List<ToDoListData> noOfBorrowers = new ArrayList<ToDoListData>();
            noOfBorrowers = retrieveNoOfBorrowersForLanding().stream().collect(Collectors.toList());
    ...
    public JSONObject branchManagerLandingRetrieveDashboardTemplate(String chartType, DateParam from, DateParam to) {
        ...
        if (chartType.equalsIgnoreCase("Portfolio")) {
            ...
            if (from != null && to != null) {
                ...
                currentMonth = retrieveBranchManagerPortfolioForLanding(fromDate, toDate, branchId).stream().collect(Collectors.toList());
        ...
        if (chartType.equalsIgnoreCase("Delinquency")) {
            ...
            // LocalDate fromDate = new LocalDate("yyyy-MM-dd").parse(String.valueOf(new
            // java.util.Date().getYear())+"-01-01");
            List<BranchManagerDelinquencyData> retrieveBranchManagerDelinquency = new ArrayList<BranchManagerDelinquencyData>();
            retrieveBranchManagerDelinquency = retrieveBranchManagerDelinquencyForLanding(newfromdate, newtodate, branchId, delinquentdays)
                    .stream().collect(Collectors.toList());

            // String[] categories = {"January", "February", "March", "April", "May", "June", "July", "August",
        ...
        if (chartType.equalsIgnoreCase("todolist")) {
            ...
            pendingApprovalLoans = retrieveManagerpendingApprovalLoans(branchId).stream().collect(Collectors.toList());

            List<ToDoListData> endOfMonthClosing = new ArrayList<ToDoListData>();
            endOfMonthClosing = retrieveManagerEndOfMonthClosing(branchId).stream().collect(Collectors.toList());

            List<ToDoListData> activeLoanSummary = new ArrayList<ToDoListData>();
            activeLoanSummary = retrieveManagerActiveLoanSummary(branchId).stream().collect(Collectors.toList());
    ...
    @Override
    public JSONObject loanOfficerLandingLandingRetrieveDashboardTemplate(String chartType, DateParam from, DateParam to) {
        AppUser user = this.context.authenticatedUser();
        ...
        if (chartType.equalsIgnoreCase("Customers")) {
            ...
            if (from != null && to != null) {
                ...
                currentCustomer = retrieveloanOfficerCustomersForLanding(fromDate, toDate, officerId).stream().collect(Collectors.toList());
        ...
        if (chartType.equalsIgnoreCase("Collection")) {
            // List<LoanOfficerCollectionsData> loanOfficerCollectionsList = new
            // ArrayList<LoanOfficerCollectionsData>();
        ...
        if (chartType.equalsIgnoreCase("Portfolio")) {
            ...
            if (from != null && to != null) {
                ...
                currentMonth = retrieveloanOfficerPortfolioForLanding(fromDate, toDate, officerId).stream().collect(Collectors.toList());
        ...
        if (chartType.equalsIgnoreCase("Delinquency")) {
            ...
            loanOfficerDelinquencyList = retrieveloanOfficerDelinquencyForLanding(newfromdate, newtodate, officerId, delinquentdays)
                    .stream().collect(Collectors.toList());
    ...
    public Collection<DurationChartData> retrieveSavingsBalancePerBranchForLanding(final DateParam from, final DateParam to,
    ...
    private static final class PieChartMapper implements RowMapper<PieChartData> {
        ...
        @Override
        public PieChartData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
    ...
    private static final class StackedChartMapper implements RowMapper<StackedChartData> {
        ...
        @Override
        public StackedChartData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
    ...
    private static final class DurationChartMapper implements RowMapper<DurationChartData> {
        ...
        @Override
        public DurationChartData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
    ...
    private static final class WeeklyChartMapper implements RowMapper<WeeklyChartData> {
        ...
        @Override
        public WeeklyChartData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
    ...
    public Collection<BranchManagercollectionsData> retrieveBranchManagercollectionsForLanding(final Date from, final Date to,
            Long branchId) {
    ...
    public Collection<BranchManagercollectionsData> retrieveBranchManagercollectionsTotalAmountForLanding(final Date from, final Date to,
            Long branchId) {
        final BranchManagercollectionsMapper mapper = new BranchManagercollectionsMapper();
    ...
    public Collection<BranchManagerDelinquencyData> retrieveBranchManagerDelinquencyForLanding(final Date fromDate, final Date toDate,
            final Long branchId, final Long delinquentdays) {
    ...
    public Collection<LoanOfficerCollectionsData> retrieveloanOfficerCollectionsForLanding(final Date from, final Date to,
    ...
    public Collection<LoanOfficerCollectionsData> retrieveloanOfficerCollectionsTotalAmountForLanding(final Date from, final Date to,
            final Long officerId) {
        final LoanOfficerCollectionsMapper mapper = new LoanOfficerCollectionsMapper();
    ...
    public Collection<LoanOfficerDelinquencyData> retrieveloanOfficerDelinquencyForLanding(final Date from, final Date to,
            final Long officerId, final Long delinquentdays) {
    ...
    public Collection<LoanOfficerPortfolioData> retrieveloanOfficerPortfolioForLanding(final Date from, final Date to,
            final Long officerId) {
    ...
    private static final class BranchManagerDelinquencyMapper implements RowMapper<BranchManagerDelinquencyData> {
        ...
        @Override
        public BranchManagerDelinquencyData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
    ...
    private static final class ToDoListMapper implements RowMapper<ToDoListData> {
        ...
        @Override
        public ToDoListData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
    ...
    private static final class BranchManagercollectionsMapper implements RowMapper<BranchManagercollectionsData> {
        ...
        @Override
        public BranchManagercollectionsData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
    ...
    private static final class BranchManagerPortfoliosMapper implements RowMapper<BranchManagerPortfolioData> {
        ...
        @Override
        public BranchManagerPortfolioData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final BigDecimal amount = JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "amount");
    ...
    private static final class LoanOfficerCustomersMapper implements RowMapper<LoanOfficerCustomersData> {
        ...
        @Override
        public LoanOfficerCustomersData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final Long count = JdbcSupport.getLong(rs, "count");
    ...
    private static final class LoanOfficerCollectionsMapper implements RowMapper<LoanOfficerCollectionsData> {
        ...
        @Override
        public LoanOfficerCollectionsData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final BigDecimal amount = JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "amount");
    ...
    private static final class LoanOfficerPortfolioMapper implements RowMapper<LoanOfficerPortfolioData> {
        ...
        @Override
        public LoanOfficerPortfolioData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final BigDecimal amount = JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "amount");
    ...
    public ViewDetailsData retrieveviewdetails(String ViewDetailsName, DateParam from, DateParam to) {
        ...
        if (ViewDetailsName.equalsIgnoreCase("generalLoanApproval")) {
            pendingApprovalLoansDataGeneral = retrievependingApprovalLoansDetailsForGeneral(from, to).stream().collect(Collectors.toList());
        }

        if (ViewDetailsName.equalsIgnoreCase("ManagerCustomers")) {

            pendingApprovalLoansData = retrievependingApprovalLoans(from, to).stream().collect(Collectors.toList());
        }
        if (ViewDetailsName.equalsIgnoreCase("ManagerActiveLoanSummary")) {

            ManagerActiveLoanSummaryData = retrieveManagerActiveLoanSummaryDetails(branchId).stream().collect(Collectors.toList());
        }
        ...
        if (ViewDetailsName.equalsIgnoreCase("ViewManagerCollection")) {
            ...
            viewManagerCollectionData = viewManagerCollectionDataSummaryDetails(from, to, branchId).stream().collect(Collectors.toList());
        }
        if (ViewDetailsName.equalsIgnoreCase("ViewManagerPortfolio")) {

            viewManagerPortfolioData = viewManagerPortfolioDataSummaryDetails(from, to, branchId).stream().collect(Collectors.toList());
        }
        if (ViewDetailsName.equalsIgnoreCase("ViewOfficerPortfolio")) {

            viewOfficerPortfolioData = viewOfficerPortfolioDataSummaryDetails(from, to, officerId).stream().collect(Collectors.toList());
        }
        if (ViewDetailsName.equalsIgnoreCase("ViewOfficerCollection")) {

            viewOfficerCollectionData = viewOfficerCollectionDataSummaryDetails(from, to, officerId).stream().collect(Collectors.toList());
        }
        if (ViewDetailsName.equalsIgnoreCase("ViewOfficerCustomers")) {

            viewOfficerCustomersData = viewOfficerCustomersSummaryDetails(from, to, officerId).stream().collect(Collectors.toList());
        }
        ...
        return new ViewDetailsData(pendingApprovalLoansData, ManagerActiveLoanSummaryData, viewManagerPendingApprovalLoansData,
                viewManagerEndOfMonthClosingLoansData, viewManagerCollectionData, viewManagerPortfolioData, viewOfficerPortfolioData,
                viewOfficerCollectionData, viewOfficerCustomersData, viewOfficerPendingApprovalLoansData, pendingApprovalLoansDataGeneral);
    }
    ...
    private static final class PendingApprovalLoansMapper implements RowMapper<PendingApprovalLoansData> {
        ...
        @Override
        public PendingApprovalLoansData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
    ...
    private static final class ManagerActiveLoanSummaryDetailsMapper implements RowMapper<ManagerActiveLoanSummaryData> {
        ...
        @Override
        public ManagerActiveLoanSummaryData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final String accNo = rs.getString("accNo");
            final String name = rs.getString("name");
    ...
    public List<ViewManagerCollectionData> viewManagerCollectionDataSummaryDetails(final DateParam from, final DateParam to,
            final Long branchId) {
    ...
    private static final class ViewManagerCollectionMapper implements RowMapper<ViewManagerCollectionData> {
        ...
        @Override
        public ViewManagerCollectionData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final String accNo = rs.getString("accNo");
            final String name = rs.getString("name");
            final String officerName = rs.getString("officerName");
    ...
    public List<ViewManagerPortfolioData> viewManagerPortfolioDataSummaryDetails(final DateParam from, final DateParam to,
            final Long branchId) {
    ...
    private static final class ViewManagerPortfolioMapper implements RowMapper<ViewManagerPortfolioData> {
        ...
        @Override
        public ViewManagerPortfolioData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final String accNo = rs.getString("accNo");
            final String name = rs.getString("name");
            final Long mobNo = rs.getLong("mobNo");
            final String gender = rs.getString("gender");
    ...
    public List<ViewOfficerPortfolioData> viewOfficerPortfolioDataSummaryDetails(final DateParam from, final DateParam to,
            final Long officerId) {
    ...
    private static final class ViewOfficerPortfolioMapper implements RowMapper<ViewOfficerPortfolioData> {
        ...
        @Override
        public ViewOfficerPortfolioData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final String accNo = rs.getString("accNo");
            final String name = rs.getString("name");
            final Long mobNo = rs.getLong("mobNo");
            final String gender = rs.getString("gender");
    ...
    public List<ViewOfficerCollectionData> viewOfficerCollectionDataSummaryDetails(final DateParam from, final DateParam to,
            final Long officerId) {
    ...
    private static final class ViewOfficerCollectionMapper implements RowMapper<ViewOfficerCollectionData> {
        ...
        @Override
        public ViewOfficerCollectionData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final String accNo = rs.getString("accNo");
            final String name = rs.getString("name");
            final Long mobNo = rs.getLong("mobNo");
            final String gender = rs.getString("gender");
    ...
    public List<ViewOfficerCustomersData> viewOfficerCustomersSummaryDetails(final DateParam from, final DateParam to,
            final Long officerId) {
    ...
    private static final class ViewOfficerCustomersMapper implements RowMapper<ViewOfficerCustomersData> {
        ...
        @Override
        public ViewOfficerCustomersData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final String accNo = rs.getString("accNo");
            final String name = rs.getString("name");
            final String mobNo = rs.getString("mobNo");
            final String gender = rs.getString("gender");
    ...
    public JSONObject retrieveClientDashboardTemplate(Long clientId) {
        ...
        loanPerformanceData = retrieveLoanPerformanceForLanding(clientId).stream().collect(Collectors.toList());

        List<LoanPerformanceDueData> loanPerformanceDueData = new ArrayList<LoanPerformanceDueData>();
        loanPerformanceDueData = retrieveLoanPerformanceDueForLanding(clientId).stream().collect(Collectors.toList());
    ...
    private static final class LoanPerformanceMapper implements RowMapper<LoanPerformanceData> {
        ...
        @Override
        public LoanPerformanceData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
    ...
    private static final class LoanPerformanceDueMapper implements RowMapper<LoanPerformanceDueData> {
        ...
        @Override
        public LoanPerformanceDueData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            final BigDecimal due = JdbcSupport.getBigDecimalDefaultToZeroIfNull(rs, "due");
